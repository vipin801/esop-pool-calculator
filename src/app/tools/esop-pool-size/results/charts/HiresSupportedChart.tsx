      ...
      <div className="h-[220px]">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={data} margin={{ top: 8, right: 8, bottom: 0, left: 0 }}>
            ...
            <YAxis tickLine={false} axisLine={false} fontSize={11} width={40} tickFormatter={(v: number) => formatIndian(v)} />
            <Tooltip
            ...
            />
            <Bar dataKey="planned" name="Planned (cumulative)" fill={p.neutralSoft} radius={[3, 3, 0, 0]} />
            <Line
              type="monotone"
